<script lang="ts">
	...
	const pages = supportInfo.find((e) => e.category.name === 'External')?.pages;
</script>

<div class="top-level-section">
	<SectionHeadingTopLevel title={'External'} />
	<div class="spaced-paragraph">
		{supportInfo.find((e) => e.category.name === 'External')?.category
			.description}
	</div>
