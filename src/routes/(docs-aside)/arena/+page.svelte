	...
	<section>
		...
		<section>
			...
			<div>
				...
				<p class="spaced-paragraph">
					Colors other than Green, Red and White require that you have reached
					at least HR3 to be used.
				</p>
				<p class="spaced-paragraph">
					The menu to customise the color used is unlocked by creating or
					otherwise obtaining an armor piece that lets you set its color. You
					can do this by buying the T-Shirt that the NPC wearing glasses in the
					<InlineTooltip
						text="Blacksmith"
						tooltip="Location"
				...
				<p class="spaced-paragraph">
					If your total points for Green, Red or White pass 100, the total
					points of all three goes down by -30.
				</p>
			</div>
			<div>
				<DataTable
		...
		<section>
			...
			<div>
				<p>
					Lunchboxes (or Bentos) are buffs that you set at the quest counter
					menu, right before embarking on a quest.
				</p>
