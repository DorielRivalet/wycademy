...
\\text{inputNumberDefenseRate} \\times\\newline \\text{inputNumberMonsterRage} \\times\\newline \\text{inputNumberHCModifiers}\\end{align}`);
	...
	let openIntroduction = $state(false);
	let openSavingLoadingSection = $state(false);
	let openInputsSection = $state(true);
	let openResultsSection = $state(true);
				...
				<div>
					<Accordion>
									...
									<div class="input-sections-container">
												...
												<div class="driverjs-1">
													...
													>
														{#snippet children({ item })}
															{@const SvelteComponent_2 = getWeaponIcon(
																item.id,
															)}
															<div class="option-item">
																<div>
																	<SvelteComponent_2 {...{ size: '32px' }} />
																</div>
										...
										<div class="input-section">
											...
											<div class="inputs-group-column">
												...
												>
													{#snippet children({ item })}
														{@const SvelteComponent_3 = getElementIcon(item.id)}
														<div class="option-item">
															<div>
																<SvelteComponent_3 {...{ size: '32px' }} />
															</div>
										...
										<div class="input-section">
											...
											<div class="inputs-group-column">
												...
												>
													{#snippet children({ item })}
														{@const SvelteComponent_4 = getStatusIcon(item.id)}
														<div class="option-item">
															<div>
																<SvelteComponent_4 {...{ size: '32px' }} />
															</div>
						...
						<AccordionItem>
							{#snippet title()}
								<h5 class="accordion-title">
									<span><CharacterWholeNumber /></span><span>Inputs Logs</span>
								</h5>
							{/snippet}
							...
							<CodeSnippet type="multi" hideCopyButton showMoreLess={false}>
								<div>
									...
									{:else}
										<p>
											No logs found. Try modifying the inputs of the damage
											calculator.
										</p>
									{/if}
								</div>
						...
						<Accordion class="spaced-accordion">
							<AccordionItem>
								...
								<UnorderedList>
									...
									<ListItem>
										<p>
											The final output of all your calculations is in 🗡️ Final
											Attack, defined as Internal Attack in the calculator's
											code.
										</p>
									</ListItem>
									<ListItem>
										<p>
											If you select an option in a dropdown exclusive to a
											weapon and then change weapon type thus hiding that
											dropdown, the selected option will still apply.
										</p>
									</ListItem>
									<ListItem>
										<p>
						...
						>
							...
							<Toolbar
								><div class="toolbar driverjs-4">
									...
									>
										{#snippet children({ item })}
											{@const SvelteComponent_5 = getWeaponIcon(item.id)}
											<div class="option-item">
												<div>
													<SvelteComponent_5 {...{ size: '32px' }} />
												</div>
