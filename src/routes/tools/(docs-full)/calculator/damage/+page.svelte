			...
			steps: [
				...
				},
				{
					...
					popover: {
						title: 'Help',
						description:
							"We offer a Help section in case you need more context or information. If you were a user of other calculators, we also detail what Wycademy\'s Calculator has to offer.",
					},
				},
				{
					element: '.driverjs-8',
...
<TableOfContentsPage displayTOC={true}>
	<div class={modalBlurClass}>
		<div>
			...
			<div class="initial-buttons driverjs-8">
				<Button
				...
				<div>
					<Accordion>
								...
								<div>
									<Tabs type="container">
										...
										<svelte:fragment slot="content">
											...
											<TabContent
												><div class="container-tab-content">
													<p>Currently, it is not possible to load by URL.</p>
												</div></TabContent
											>
										</svelte:fragment>
									</Tabs>
						...
						<Accordion class="spaced-accordion">
							<AccordionItem bind:open={openHelpSection}>
								<svelte:fragment slot="title">
									<h5 class="accordion-title">
