...
<script lang="ts">
	...
	function saveInputsAsJSONFile(input: string) {
		...
		link.href = url;
		link.download = 'wycademy-damage-calculator-inputs.json'; // You can customize the filename here
										...
										<svelte:fragment slot="content">
																...
																<div class="input-section">
																	...
																	<div class="inputs-group-column">
																		...
																		<div class="dropdown-tooltip-container">
																			<Tooltip align="start">
																				<p class="spaced-paragraph">
																					This isn’t a final multiplier—just
																					extra true raw damage.
																				</p>
																				<p>
																					Example: Weapons Art Large on a 600
																					true raw weapon adds the same as +30
																					Attack or Attack Up Very Large (600 ×
																					0.05).
																				</p>
																			</Tooltip>
																			<Dropdown
																		...
																		<div class="dropdown-tooltip-container">
																			<Tooltip align="start">
																				<p>
																					You don’t need over 100% affinity to
																					gain True Raw.
																				</p>
																			</Tooltip>
																			<Dropdown
																		...
																		<div class="number-input-container">
																			...
																			>
																				<span slot="label"
																					...
																					>
																						<p class="spaced-paragraph">
																							Every attack that successfully
																							leeches adds extra true raw, up to
																							+80.
																						</p>
																		...
																		<div class="dropdown-tooltip-container">
																			<Tooltip align="start">
																				<p>
																					Adjusts base True Raw when using a
																					Length Up sigil on a G Rank weapon.
																					The reduction doesn’t stack—using 3
																					sigils has the same effect as 1.
																				</p>
																			</Tooltip>
																			<Dropdown
																				titleText="Length Up"
																		...
																		<div class="number-input-container">
																			<NumberInput
																				...
																				><span slot="label"
																					...
																					>
																						<p>
																							Attack increases every 5 floors,
																							stopping at 26.
																						</p>
																					</Tooltip></span
																				>
																		...
																		<div class="number-input-container">
																			...
																			>
																				<span slot="label"
																					...
																					>
																						<p>
																							Displays the skill’s value in your
																							SR stats when enabled. Works only
																							in standard Conquest quests.
																							<strong
																								>Does not apply to Shiten
																								quests.</strong
																							>
																						</p>
																					</Tooltip></span
																		...
																		<div class="dropdown-tooltip-container">
																			<Tooltip align="start">
																				<p>
																					Toggle this if you’ve used a Conquest
																					Attack Potion in a standard Conquest
																					quest.
																					<strong
																...
																<div class="input-section">
																	...
																	<div class="inputs-group-column">
																		<div class="dropdown-tooltip-container">
																			<Tooltip align="start">
																				<p class="spaced-paragraph">
																					These buffs apply only if you're using
																					a Gou tree weapon in a Gou, Supremacy,
																					or G Rank quest.
																				</p>
																				<p>
																					Example: Normal Lv50 weapons get no
																					buffs, but a G Supremacy Weapon with 2
																					matching armor pieces adds +40 to
																					final damage.
																				</p>
																			</Tooltip>
																			<Dropdown
																		...
																		<div class="number-input-container">
																			...
																			>
																				<span slot="label"
																					...
																					>
																						<p>
																							Your highest attack level in SR
																							info. Max is 100.
																						</p>
																					</Tooltip></span
																				>
																	...
																	<div class="input-section">
																		...
																		<div class="inputs-group-column">
																			<div class="dropdown-tooltip-container">
																				<Tooltip align="start">
																					<p>
																						Check the Critical Distance section
																						for this multiplier’s graph.
																					</p>
																				</Tooltip>
																				<Dropdown
																			...
																			{#if inputWeaponType === 'Bow'}
																				<div class="dropdown-tooltip-container">
																					<Tooltip align="start">
																						<p>
																							Adjusts for Consumption Slayer,
																							which doubles coating use for an
																							extra +0.2× multiplier.
																						</p>
																					</Tooltip>
																		...
																		<div class="number-input-container">
																			...
																			>
																				<span slot="label"
																					...
																					>
																						<p class="spaced-paragraph">
																							Use these values for Elemental
																							Sword Crystals: Standard: 500,
																							700, 900 GR600: 1300, 1500, 2100
																						</p>
																						<p>
																							This replaces your weapon’s
																							elemental value, so set the
																							element accordingly.
																						</p>
																					</Tooltip></span
																				>
																		...
																		<div class="number-input-container">
																			...
																			>
																				<span slot="label">
																					...
																					>
																						<p>
																							Enter other extra damage (like
																							bombs or blast status) to be
																							calculated against only the
																							defense rate.
																						</p>
																					</Tooltip>
																				</span>
																	...
																	<div class="inputs-group-column">
																		<div class="driverjs-2">
																			<ComboBox
																				on:select={() => {
																					selectedMonsterState =
																						availableMonsterStates[0]?.id ||
																						'Default';
																					selectedMonsterRankBand =
																						availableRankBands[0]?.id ||
																						'Default';
																				}}
																				titleText="Monster"
																		...
																		<div class="number-input-container">
																			...
																			>
																				<span slot="label"
																					...
																					>
																						<p>
																							Find the defense rate using the
																							overlay. The overlay already
																							includes rage and hardcore
																							modifiers.
																						</p>
																					</Tooltip></span
																				>
																		...
																		<div class="number-input-container">
																			...
																			>
																				<span slot="label"
																					...
																					>
																						<p>
																							If this is locked, remove the
																							selected monster in the dropdown
																							above to edit. This applies to
											...
											<TabContent>
												<div class="container-tab-content">
													...
													{/if}
													<div
														class="damage-calculator-diva-prayer-gems-container"
													>
														<div class="diva-stats-values">
															<div class="diva-prayer-gem">
																...
																<Dropdown
																	...
																	on:select={(e) => {
																		if (inputDivaPrayerGemRedName === 'None') {
																			inputNumberDivaPrayerGemRedLevel = 0;
														...
														<svelte:fragment slot="content">
															<TabContent>
																<div class="container-tab-content">
																	...
																	<div>
																		<p class="spaced-paragraph">
																			The Wycademy Calculator is a powerful tool
																			that not only provides all the features
																			you'd expect but also introduces several
																			quality-of-life improvements and fixes for
																			calculation accuracy. Below is a
																		...
																		<p class="spaced-paragraph">
																			In addition to core calculations, the
																			Wycademy Calculator offers modern web
																		...
																		<UnorderedList class="spaced-list">
																			...
																			<ListItem
																				><p>
																					Motion values categorized by weapon
																					style and section.
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					Draggable panels for a customizable
																					workspace.
																				</p></ListItem
																			>
																			<ListItem
																			...
																			<ListItem
																				><p>
																					Automatic hiding of element columns
																					irrelevant to the selected element.
																				</p></ListItem
																			>
																			<ListItem>
																				<p>
																					<strong>Improved reactivity:</strong> No
																					need for extra button clicks—affinity calculations
																					update automatically.
																				</p>
																			</ListItem>
																			<ListItem
																				><p>
																					Switch Axe F meter drain column in the
																					motion values table.
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					Tonfa guard points column in the
																					motion values table.
																				</p></ListItem
																			>
																		</UnorderedList>
																		<p class="spaced-paragraph">
																			Additionally, Wycademy's Calculator fixes
																			numerous inaccuracies that were present in
																			other tools:
																		</p>
																		<UnorderedList class="spaced-list">
																			<ListItem
																				><p>
																					<strong
																						>Corrects miscalculations of
																						multi-hit motion values.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Ensures accurate affinity
																						calculations with real-time updates.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Supports code sharing with an open
																						MIT license.</strong
																					>
																				</p></ListItem
																			>
																			...
																			<ListItem
																				><p>
																					<strong
																						>Corrects Tonfa motion values and
																						categorizes them by weapon style.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Improves formulas for Zenith and
																						AoE Sigils.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Fixes mismatched motion values
																						between styles and outdated
																						versions.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Includes a references section for
																						verification.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Eliminates discrepancies between
																						displayed and calculated motion
																						values.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Fixes spelling mistakes.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Actively maintained with issue
																						reporting available on GitHub.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						>Supports motion values for multiple
																						weapon styles.</strong
																					>
																				</p></ListItem
																			>
																			<ListItem
																				><p>
																					<strong
																						...
																						without needing to download.</strong
																					>
																				</p></ListItem
																			>
																		</UnorderedList>
																		<p class="spaced-paragraph">
																			<strong
																				>Note: Refreshing the page resets all
																				values.</strong
																			>
																		</p>
																	</div>
												...
												<div class="container-tab-content">
													<div class="driverjs-3">
														<div class="stats-values">
															...
															<div class="internal-true-raw">
																⚔️ True Raw: {internalTrueRaw}
															</div>
															<div class="bloat">
																⚔️ Bloat Raw: {internalTrueRawDisplay}
															</div>
															...
															<div class="attack">
																🗡️ Final Attack: {internalAttack}
															</div>
															<div class="affinity">
																✨ Affinity: {internalAffinity}%
															</div>
														</div>
													</div>
												</div>
														...
														<svelte:fragment slot="content">
															<TabContent
																><div class="container-tab-content">
																	...
																	<div
																		class="damage-calculator-container-buttons"
																	>
															...
															<Toolbar
																><div class="toolbar driverjs-4">
																	...
																	<Button
																		kind="tertiary"
																		icon={Download}
																		on:click={downloadMotionValuesImage}
																		>Download</Button
																	>
																</div>
															</Toolbar>
															...
															<Toolbar
																><div class="toolbar">
																	...
																	<Button
																		kind="tertiary"
																		icon={Download}
																		on:click={downloadSharedMotionValuesImage}
																		>Download</Button
																	>
																</div>
															</Toolbar>
															...
															<svelte:fragment slot="content">
																<TabContent
																	><section class="tab-content">
																		...
																		<div class="formula-container">
																			{@html display(
																				formulaValuesOutputInternalAttack,
																			)}
																		</div>
																	</section></TabContent
																>
																...
																<TabContent
																	><section class="tab-content">
																		...
																		<div class="formula-container">
																			{@html display(
																				formulaValuesOutputMultipliers,
																			)}
																		</div>
																	</section></TabContent
																>
																<TabContent
																	><section class="tab-content">
																		...
																		<div class="formula-container">
																			{@html display(
																				formulaValuesOutputFlatAdditions,
																			)}
																		</div>
																	</section></TabContent
																>
																...
																<TabContent>
																	<section class="tab-content">
																		...
																		<div class="formula-container">
																			{@html display(
																				formulaValuesOutputTotalAffinity,
																			)}
																		</div>
																	</section></TabContent
																>
																...
																<TabContent
																	><section class="tab-content">
																		...
																		<div class="formula-container">
																			{@html display(
																				formulaValuesOutputOtherMultipliers,
																			)}
																		</div>
																	</section></TabContent
																>
																<TabContent
																	><section class="tab-content">
																		...
																		<div class="formula-container">
																			{@html display(
																				formulaValuesOutputStatusUsedSA,
																			)}
																		</div>
																	</section></TabContent
																>
																<TabContent
																	><section class="tab-content">
																		...
																		<div class="formula-container">
																			{@html display(
																				formulaValuesOutputMonsterTotalDefense,
																			)}
																		</div>
																	</section></TabContent
																>
...
<style lang="scss">
	...
	.stats-values {
		...
		gap: 1rem;
		grid-template-areas:
			'attack internal-true-raw'
			'bloat affinity'
			'attack-ceiling my-missions'
			'fire water'
			'thunder ice'
			'dragon status';
		text-align: center;
