import AcornIconWhite from '$lib/client/components/frontier/icon/item/Acorn_White.svelte';
import AmmoClusterIconWhite from '$lib/client/components/frontier/icon/item/Ammo_Cluster_White.svelte';
import AmmoPierceIconWhite from '$lib/client/components/frontier/icon/item/Ammo_Pierce_White.svelte';
import AmmoSpreadIconWhite from '$lib/client/components/frontier/icon/item/Ammo_Spread_White.svelte';
import AmmoStickyIconWhite from '$lib/client/components/frontier/icon/item/Ammo_Sticky_White.svelte';
...
import BallistaIconWhite from '$lib/client/components/frontier/icon/item/Ballista_Ammo_White.svelte';

import BambooIconWhite from '$lib/client/components/frontier/icon/item/Bamboo_White.svelte';
...
import BowgunModEquipmentIconWhite from '$lib/client/components/frontier/icon/item/Bowgun_Mod_Equipment_White.svelte';
...
import CannonAmmoIconWhite from '$lib/client/components/frontier/icon/item/Cannon_Ammo_White.svelte';
...
import ConsumableIconWhite from '$lib/client/components/frontier/icon/item/Consumable.svelte';

import CrystalIconWhite from '$lib/client/components/frontier/icon/item/Crystal_Icon_White.svelte';
...
import HuskIconWhite from '$lib/client/components/frontier/icon/item/Husk_White.svelte';
...
import NectarIconWhite from '$lib/client/components/frontier/icon/item/Nectar_White.svelte';
...
import PetalaceIconWhite from '$lib/client/components/frontier/icon/item/Petalace_White.svelte';
...
import WirebugIconWhite from '$lib/client/components/frontier/icon/item/Wirebug_White.svelte';
...
export const itemInfo: { name: string; icon: any }[] = [
	...
	{
		name: 'Ammo Cluster',
		icon: AmmoClusterIconWhite,
	},
	{
		name: 'Ammo Pierce',
		icon: AmmoPierceIconWhite,
	},
	{
		name: 'Ammo Spread',
		icon: AmmoSpreadIconWhite,
	},
	{
		name: 'Ammo Sticky',
		icon: AmmoStickyIconWhite,
	},
	{
		name: 'Armor Sphere',
	...
	{
		name: 'Ballista',
		icon: BallistaIconWhite,
	},
	{
		name: 'Bamboo',
		icon: BambooIconWhite,
	},
	{
		name: 'Barrel',
	...
	{
		name: 'Bowgun Mod Equipment',
		icon: BowgunModEquipmentIconWhite,
	},
	{
		name: 'Bug',
		icon: BugIconWhite,
	...
	{
		name: 'Consumable',
		icon: ConsumableIconWhite,
	},
	{
		name: 'Crystal',
		icon: CrystalIconWhite,
	},
	{
		name: 'Egg',
		icon: EggIconWhite,
