...
export const legacyCalculatorValuesMap: {
...
}[] = [
	{
		...
		ACincite: { '0': 'Inactive', '40': 'Active (+40)' },
		...
		elementtype: {
			...
			'4': 'Ice (冰)',
			'3': 'Dra (龍)',
			'5': 'Light (光) (70% Fir, 70% Tnd)',
			'6': 'Blaze (炎) (70% Fir, 70% Dra)',
			'7': 'Tenshou (天翔) (30% Fir, 100% Wat, 70% Tnd)',
			'8': 'Lightning R. (雷棰) (70% Tnd, 70% Dra)',
			'9': 'Okiko (熾凍) (80% Fir, 80% Ice, 40% Dra)',
			'10': 'Black Flame (黑焰) (50% Fir, 150% Dra)',
			'11': 'Crimson D. (紅魔) (50% Dra, 150% Fir)',
			'12': 'Dark (闇) (80% Ice, 80% Dra)',
			'13': 'Music (奏) (100% Wat, 100% Ice)',
			'14': 'Sound (響) (100% Wat, 100% Dra)',
			'15': 'Wind (風) (80% Tnd, 80% Ice)',
